        ...
        <div style={G.app}>
            ...
            <div style={{ maxWidth: "760px", margin: "0 auto", padding: "28px 20px" }}>
                <div style={{ marginBottom: "20px" }}>
                    ...
                    {partsError && (
                        <p style={{ color: "#e04444", fontSize: "12px", marginTop: "10px" }}>{partsError}</p>
                    )}
                    {!partsLoading && !partsError && visibleParts.length === 0 && (
                        <p style={{ color: "#666", fontSize: "12px", marginTop: "10px" }}>Start a repair from Repairs page to load compatible parts from RockAuto.</p>
                    )}
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 80px 80px 80px 90px 120px", gap: "8px", padding: "6px 14px", fontSize: "10px", color: "#444", letterSpacing: "0.1em", borderBottom: "1px solid #1e1e1e", marginBottom: "8px" }}>
                    <span>PART</span><span style={{ textAlign: "center" }}>TYPE</span><span style={{ textAlign: "center" }}>SOURCE</span><span style={{ textAlign: "right" }}>PRICE</span><span style={{ textAlign: "right" }}>OEM</span><span />
                </div>
