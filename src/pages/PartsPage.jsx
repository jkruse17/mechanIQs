...
export default function PartsPage({ G, goHome, setScreen, vehicle, partsLoading, partsError, categories, catFilter, setCatFilter, visibleParts, diffColor, diffLabel, startRepair, selectedPart, choosePartOnly, goToTutorial }) {
    return (
        <div style={G.app}>
